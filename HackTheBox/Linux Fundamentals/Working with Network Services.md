...
```shell-session
Precious@htb[/htb]$ apt install apache2 -y
...
![[Pasted image 20240905231256.png]]
...
```shell-session
Precious@htb[/htb]$ curl http://localhost
...
```shell-session
Precious@htb[/htb]$ wget http://localhost
...
```shell-session
Precious@htb[/htb]$ python3 -m http.server

Serving HTTP on 0.0.0.0 port 8000 (http://0.0.0.0:8000/) ...
```

![[Pasted image 20240905231325.png]]
