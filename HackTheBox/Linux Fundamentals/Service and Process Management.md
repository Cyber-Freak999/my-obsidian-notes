...
```shell-session
Precious@htb[/htb]$ systemctl enable ssh
...
```shell-session
Precious@htb[/htb]$ ps -aux | grep ssh
...
```shell-session
Precious@htb[/htb]$ systemctl list-units --type=service
...
```shell-session
Precious@htb[/htb]$ journalctl -u ssh.service --no-pager
...
```shell-session
Precious@htb[/htb]$ ping -c 10 www.hackthebox.eu

Precious@htb[/htb]$ vim tmpfile
[Ctrl + Z]
...
```shell-session
Precious@htb[/htb]$ echo '1'; echo '2'; echo '3'
...
```shell-session
Precious@htb[/htb]$ echo '1'; ls MISSING_FILE; echo '3'
