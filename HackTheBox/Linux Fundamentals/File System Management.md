...
```shell-session
Precious@htb[/htb]$ cat /etc/fstab
...
```shell-session
Precious@htb[/htb]$ sudo mount /dev/sdb1 /mnt/usb
Precious@htb[/htb]$ cd /mnt/usb && ls -l
...
```shell-session
Precious@htb[/htb]$ sudo umount /mnt/usb
```
